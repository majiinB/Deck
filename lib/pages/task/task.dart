...
class _TaskPageState extends State<TaskPage>{
  ...
  List<String> taskTitles = [
    ...
    'taskTitle7','taskTitle8','taskTitle9',
        'taskTitle10','taskTitle11','taskTitle12',
    'taskTitle13','taskTitle14','taskTitle15',
    'taskTitle16','taskTitle17','taskTitle18',
    'taskTitle19','taskTitle20','taskTitle21',
    'taskTitle22','taskTitle23','taskTitle24',
    'taskTitle25','taskTitle26','taskTitle27'
  ];
               ...
               tabContent: [
                 ...
                 if (isThereTask(selectedDay,taskDeadlines))
                   ...
                   itemBuilder: (context, index) {
                     if (!isDone[index] && isSameDay(taskDeadlines[index],selectedDay)) {
                       return Padding(
                         ...
                         child: DeckTaskTile(
                           ...
                           onTap: () {
                             ...
                             Navigator.push(
                               context,
                               MaterialPageRoute(builder: (context) => const ViewTaskPage()),
                             );
                           },
                         ),
                       );
                     } else {
                       return const SizedBox(height: 0); // Placeholder for empty space
                     }
                   },
                 ),
                 // Done Tab
                 if (!isThereTask(selectedDay,taskDeadlines))
                   ifDeckEmpty(ifDeckEmptyText: 'No Task fo Today.',
                       ifDeckEmptyheight: MediaQuery.of(context).size.height * 0.2,),
